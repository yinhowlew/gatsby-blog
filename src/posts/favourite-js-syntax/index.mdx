...
description:  and some modern JS books
...
<b4 />
<h3>Top modern JavaScript books:</h3>

1. [JavaScript Mental Model](https://justjavascript.com/) by Dan Abramov
2. [You Don't Know JS](https://github.com/getify/You-Dont-Know-JS)
3. [Eloquent JavaScript](https://eloquentjavascript.net/)
4. [Javascript.info](http://javascript.info/)
5. [JavaScript the Core](http://dmitrysoshnikov.com/ecmascript/javascript-the-core-2nd-edition/)
