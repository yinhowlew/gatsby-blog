...
Over the years, FB has iterated and prioritised different features based on what they observe from users - Newsfeed, Group, Messenger, Gaming, and the most recent FB Shop.
...
Lee Kaifu calls FB "the most Chinese company in Silicon Valley" due to its willingness and propensities to copy features from competitors. 
...
Google started building and popularising web-based applications that began to move users to the web and threaten Microsoft's desktop app monopoly. 
...
- Amazon: retail distribution and cloud computing

- Google: web, browser, and Android

- Microsoft: OS, enterprise platform and tools

- Apple: OS and mobile/computing hardware
...
Apple will still be a strong company with its existing dominance on iOS and Mac. More importantly, our generation still vividly remembers the magic of owning an Apple's product.

But unless there is a major shift in its culture and DNA, or if they find the next visionary leader, it will likely be **stagnant** for the next 5-10 years and slowly be outpaced by other tech giants.
