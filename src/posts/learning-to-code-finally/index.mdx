...
I chose to build from scratch a front-end only partial replica of a friend’s **e-commerce (Boxgreen.co)** as it has features that I want to get more practice on, and their [website](boxgreen.co) looks good.
...
- Setup:
  ...
  - Github Pages: [https://yinhowlew.github.io/boxgreen-ecommerce-replica/](https://yinhowlew.github.io/boxgreen-ecommerce-replica/)
