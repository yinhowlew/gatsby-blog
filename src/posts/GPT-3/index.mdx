...
As for programmers, in a way, describing "button that looks like watermelon" to GPT-3 is a form of declarative coding. High-level programming language used these days are closer semantically to human language than to machine language. GPT-3 can help with syntax, but we still need programmers to problem solve, architect a solution, and give clear and coherent instruction to computer.
