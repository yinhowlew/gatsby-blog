...
- it has 175 billions parameters. Parameters are the individual weights and biases in the node connections in a neural network that the model learns and optimises. As a comparison, its predecessor GPT-2 has 1.5 billion parameters. 
