---
title: Applying for your dream job
description:  perspectives from an employer
...
0. <a href="#referral">Referral</a>
1. <a href="#resume">CV / Resume</a>
2. <a href="#interest">Hunger / Indication of Interest</a> 
3. <a href="#interview">Interview</a>
4. <a href="#questions">Asking Questions</a>
5. <a href="#seniority">Junior vs Senior Roles</a>
6. <a href="#likeability">Likeability Trumps Intelligence</a>


<h2 id="referral">0 - Referral</h2> 
...
<h2 id="interest">2 - Hunger / Indication of Interest (IOI)</h2> 
...
3. if you are making career/industry switch, make extra effort to explain the "why", elaborate your interest/passion in the new industry, and show how your different experience and perspective can be valuable.
...
<h2 id="questions">4 - Asking questions as a candidate</h2> 
...
<h2 id="seniority">5 - Junior vs Senior roles</h2> 
...
<h2 id="likeability">6 - Likeability trumps intelligence</h2> 
...
If you have watched the <a href="https://www.youtube.com/watch?v=WXuK6gekU1Y">AlphaGo documentary</a> — I highly recommend it, it's released free on Youtube — the Chinese chess dude Fan Hui is an embodiment of likeability.
