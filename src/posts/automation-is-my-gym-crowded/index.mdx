...
Building scraper is the easy part; going to gym consistently is the hard part. I will release the result here in a few weeks. 
...
const puppeteer = require('puppeteer');
const Airtable = require('airtable');
const base = new Airtable({apiKey: 'keygEzAjLzNXI5OPd'}).base('appYCYGBCnnrNjlkU');
