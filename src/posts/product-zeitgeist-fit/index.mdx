...
For most people, communiting to work is often the least favourite part of a job.
...
- there are still huge gaps in the value-added chain of upskilling: networking, mentor matching, partnership with corporations, more customised offerings for different subset of students instead of 1-size-fit-all.
