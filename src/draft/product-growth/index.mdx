...
REFER TO PRODUCT ANALYTICS FOR DUMMIES BOOK
...
Common questions:
where and why do users fall off in our onboarding funnel
how can we see emerging user behavior
which features are top performers and which features should be de-prioritized and depreciated
how does retention and conversion of users compare between our acquisition channels (organic, referral, SEO, paid)
what is the retention rate of users who have used this feature in their first 30 days
what do users do instead of converting
...
Lagging metrics
revenue - lagging success metrics. It might take months to realize there's a decrease in engagement
profit

good metrics:  product analytics that allow us to understand behaviors
define what your DAU and MAU (Active Users) mean. 
effective activer user (users who have done X)
retention numbers
engagement metrics along customer journey. 

Sequence of events called funnel. Allow us to know what are good behavioral predictors / Patterns for "good users", and we can then promote it.  E.g. you might notice customers are more likely to have good conversion or retention once they book at least three sales meetings or browsed six items.  
Aha moment! understand churn and friction (e.g. time spent on this step of funnel is too long).
Product analytics also let us know what is the happy path, and what and how often users explore alternative paths

create alignment around measurable outcomes
easier to prioritize and set the North Star Metrics

decision-making and contextual product analytics need to be decentralized and closest to local team / people who are closest to the customers (different from Business Intelligence which requires SQL and represent a single source-of-truth)
