	...
	return (
		<div className="test-gradient">
			<svg preserveAspectRatio="none" viewBox="0 0 10 30" width="100%" height="128">
				<defs>
					<linearGradient id="eased-gradient-gradient-jmjj" x1="0%" y1="0%" x2="0%" y2="100%">
				...
				<mask id="eased-gradient-mask-jmjj">
					<rect x="0" y="0" width="100%" height="100%" fill="url(#eased-gradient-gradient-jmjj)"></rect>
				</mask>
				<rect x="0" y="0" width="100%" height="100%" mask="url(#eased-gradient-mask-jmjj)" fill="var(--color-background)" style={{transition: "fill 350ms ease 0s"}}></rect>
			</svg>
		</div>
	)
}
